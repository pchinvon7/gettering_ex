...
void fline_setpoints(int spl ,int spr, float kp, int setpoint, int sensor, int endt)
    {
      while(1)
         {
             ...
             */
              ...
              if (dis.readRangeSingleMillimeters() < sensor)
                  {
                    break;
                  }
         } 
...
void fline_dis(int spl ,int spr, float kp, int sensor, int endt)    ///////////////--------> เดินเข้าไปคีบกระป๋องแบบวัดระยะ
  {
